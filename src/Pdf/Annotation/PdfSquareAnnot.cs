...
{
    public sealed class PdfSquareAnnot : PdfGeometricAnnot
    {
        #region Properties
        ...
        internal PdfSquareAnnot(PdfDictionary dict)
            : base(dict)
        { }

        public PdfSquareAnnot(xRect bounds)
            : this(new PdfRectangle(bounds))
        { }

        public PdfSquareAnnot(PdfRectangle bounds)
            : base("Square",bounds)
        { }
        ...
        {
            return new PdfSquareAnnot(elems);
        }
