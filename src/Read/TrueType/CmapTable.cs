...
namespace PdfLib.Read.TrueType
{
    ...
    internal class CmapTable : Table
    {
        ...
        public CmapTable(StreamReaderEx r)
            : this(new TableDirectory(r), r)
        { }
        ...
        public CmapFormat FirstCmap 
        { 
            get 
            {
                if (_cmaps == null || _cmaps.Length == 0)
                    return null;
                var cmap = _cmaps[0];
        ...
        private static CmapFormat CreateCMap(StreamReaderEx s)
        {
            ...
            switch (format)
            {
                ...
                case 4:
                    return new CmapFormat4(s);

                case 6:
                    return new CmapFormat6(s);

                case 12:
                    return new CmapFormat12(s);

                case 13:
                    return new CmapFormat13(s);
        ...
        public abstract class CmapFormat
        {
            ...
            public virtual bool Unicode { get { return false; } }
            ...
            public struct Range
            {
                ...
                /// <summary>
                /// Used with symbolic encoding, i.e. moves a 1 byte character into
                /// a 2 byte range by slapping this number in front
                /// </summary>
                ...
                /// <summary>
                /// Checks if a character is in this range
                /// </summary>
        ...
        /// </summary>
        /// <remarks>CmapFormat2 is not fully implemented. I don't have any test data</remarks>
        class CmapFormat2
        {
            /// <summary>
        ...
        /// </summary>
        sealed class CmapFormat4 : CmapFormat
        {
            public override bool Unicode { get { return true; } }

            /// <summary>
            /// These arrays marks the start and end of every segment
            /// </summary>
            readonly ushort[] _endCount;
            readonly ushort[] _startCount;

            /// <summary>
            /// Each segment can either use contiguous mapping
            /// or thorugh the glyphIdArray.
            /// </summary>
            readonly ushort[] _idRangeOffset;

            /// <summary>
            /// How much one should offset a charcode in a range to
            /// get the glyph id. This is only relevant for 
            /// contiguous ranges. 
            /// 
            /// To find the glyph id, add this value to the charcode 
            /// and do a modulus 65536
            /// </summary>
            readonly short[] _idDelta;

            /// <summary>
            ///  If the range is not contiguous then one make a lookup
            ///  in this array for the id
            /// </summary>
            ...
            public CmapFormat4(StreamReaderEx s)
            {
                ...
                Debug.Assert(_startCount[seg_count - 1] == 0xFFFF);
            ...
            public override int GetGlyphIndex(int ch)
            {
                ...
                for (int c = 0; c < _endCount.Length; c++)
                {
                    if (_endCount[c] >= ch)
                    {
                        if (_startCount[c] <= ch)
                        {
                            //Found the segment the character belongs to
        ...
        struct CmapDescriptor
        {
            ...
            {
                PlatformID = (TrueType.PlatformID)r.ReadUShort();
